...
public class OrderItems {
    ...
    @Schema(
            title = "Item ID",
            description = "Unique identifier for the order item, used internally",
            example = "{orderID}-{uniqueItemNumber}, e.g., \'ORD123-001\'"
    )
    ...
    @Schema(
            title = "Product SKU",
            description = "Unique identifier for the product, including size",
            example = "PROD001-M"
    )
