...
@Schema(
        ...
        description = "Response model for OTP verification containing JWT, error message, and account existence status"
)
public class OtpVerifyResponse {
    ...
    @Schema(
            description = "Error message if any error occurred during OTP verification",
            example = "Invalid OTP"
    )
    String error;
